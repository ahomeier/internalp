...
There are two ways to determine $\epsilon$ - a Monte Carlo based method and a 
semi-analytic one.
...
\subfloat[$\hat{E}_{min}$ was set to $100$ 
TeV.\label{fig:Phi_norm_Emin}]{\includegraphics[width=0.45\textwidth]{%
fig/norm_g2p3_emin100TeV.pdf}}
...
% the procedure. 
% \textbf{can i do better? I think that I did. checkout 
% $emin_redon.ipynb$}
